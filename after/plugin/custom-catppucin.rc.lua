...
M.overrides = {
    ...
    highlights = {
        all = {
            ...
            GitSignsAdd = {
                fg = my_palette.diff.add
            },
            GitSignsChange = {
                fg = my_palette.diff.change
            },
            GitSignsDelete = {
                fg = my_palette.diff.delete
            },
            IndentBlanklineContextChar = {
                fg = my_palette.lavender
            },
            IndentBlanklineContextStart = {
                sp = my_palette.lavender,
                style = {"underline"}
            }
        }
        -- mocha = {
